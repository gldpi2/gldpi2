 ...
 * @author gld-pi2
 */
public class EstimationCurveMenu extends javax.swing.JPanel {
     ...
     */
    public EstimationCurveMenu(Login user) {
        initComponents();
        setSize(1024, 678);
    ...
    private void initComponents() {
        ...
        jButtonCargaHistorico = new javax.swing.JButton();
        jButtonCargaTempoReal = new javax.swing.JButton();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Estimativa de Carga", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Bitstream Charter", 1, 24))); // NOI18N
        ...
        jButtonCargaHistorico.setText("Estimativas de Carga pelo Histórico");
        jButtonCargaHistorico.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonCargaHistoricoActionPerformed(evt);
            }
        });
        jPanelTipoEstimativa.add(jButtonCargaHistorico, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 210, -1, -1));

        jButtonCargaTempoReal.setText("Estimativas de Carga em Tempo Real");
        jButtonCargaTempoReal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonCargaTempoRealActionPerformed(evt);
            }
        });
        jPanelTipoEstimativa.add(jButtonCargaTempoReal, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 210, -1, -1));
    ...
    private void jButtonCargaHistoricoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCargaHistoricoActionPerformed
        ...
        MainWindow.desktop.revalidate();
        MainWindow.desktop.repaint();
    }//GEN-LAST:event_jButtonCargaHistoricoActionPerformed

    private void jButtonCargaTempoRealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCargaTempoRealActionPerformed
        JOptionPane.showMessageDialog(jPanelTipoEstimativa, "Em desenvolvimento!", "Em Breve", JOptionPane.PLAIN_MESSAGE);
    }//GEN-LAST:event_jButtonCargaTempoRealActionPerformed

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton jButton3;
    private javax.swing.JButton jButtonCargaHistorico;
    private javax.swing.JButton jButtonCargaTempoReal;
